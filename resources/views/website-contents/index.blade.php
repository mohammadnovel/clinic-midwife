<x-admin-layout>
    <div class="mb-6 flex justify-between items-center">
        <h2 class="text-2xl font-bold text-black dark:text-white">Manajemen Konten Website</h2>
        <a href="{{ route('website-contents.create') }}"
            ...
            <table id="dataTable" class="w-full table-auto display">
                <thead>
                    <tr class="bg-gray-200 text-left dark:bg-gray-700">
                        ...
                        <th class="py-4 px-4 font-medium text-black dark:text-white">Key (ID Unik)</th>
                ...
                <tbody>
                    @foreach($contents as $content)
                        <tr>
                            ...
                            <td class="border-b border-gray-200 py-5 px-4 dark:border-gray-700">
                                <p class="font-mono text-sm text-black dark:text-white">{{ $content->key }}</p>
                            </td>
                            <td class="border-b border-gray-200 py-5 px-4 dark:border-gray-700">
                                <h5 class="font-medium text-black dark:text-white">{{ $content->title }}</h5>
                            </td>
                            <td class="border-b border-gray-200 py-5 px-4 dark:border-gray-700">
                                <span class="text-green-500 font-medium">Published</span>
                            </td>
                            <td class="border-b border-gray-200 py-5 px-4 dark:border-gray-700">
                                <div class="flex items-center space-x-3.5">
                                    <a href="{{ route('website-contents.edit', $content) }}"
                                        class="text-primary hover:underline"><i class="fas fa-edit"></i> Edit</a>
                                    <form action="{{ route('website-contents.destroy', $content) }}" method="POST"
